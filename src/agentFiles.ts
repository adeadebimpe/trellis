...
import { assertTaskId, effectivePriority, ensureWorktree, fail, leaseExpired, leaseExpiry, newClaimId, readJson, resolveMainRoot, runScript, taskEligibility, taskPath, withTaskLock, writeJson } from './_lib.mjs';
